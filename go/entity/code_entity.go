...
import (
	...
	vs "github.com/voxgig-sdk/ovationincentives-sdk/go/utility/struct"
)

type CodeEntity struct {
	name    string
	client  *core.OvationincentivesSDK
...
func NewCodeEntity(client *core.OvationincentivesSDK, entopts map[string]any) *CodeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CodeEntity) GetName() string { return e.name }
...
func (e *CodeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CodeEntity) Deleted() bool {
	return e.deleted
}


func (e *CodeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCodeEntity(e.client, opts)
}

func (e *CodeEntity) Data(args ...any) any {
...
func (e *CodeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Code; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CodeEntity) DataTyped(data ...Code) Code {
	if len(data) > 0 {
		return typedFrom[Code](e.Data(asMap(data[0])))
	}
	return typedFrom[Code](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Code (all fields
// optional at the wire level).
func (e *CodeEntity) MatchTyped(match ...Code) Code {
	if len(match) > 0 {
		return typedFrom[Code](e.Match(asMap(match[0])))
	}
	return typedFrom[Code](e.Match())
}
...
func (e *CodeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CodeEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CodeLoadMatch and returns an Code. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CodeEntity) LoadTyped(reqmatch CodeLoadMatch, ctrl map[string]any) (Code, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Code{}, err
	}
	return typedFrom[Code](res), nil
}



func (e *CodeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *CodeEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// CodeCreateData and returns an Code. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CodeEntity) CreateTyped(reqdata CodeCreateData, ctrl map[string]any) (Code, error) {
...
func (e *CodeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CodeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CodeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
