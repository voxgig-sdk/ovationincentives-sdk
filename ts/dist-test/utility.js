...
function envOverride(m) {
    if ('TRUE' === process.env.OVATIONINCENTIVES_TEST_LIVE ||
        'TRUE' === process.env.OVATIONINCENTIVES_TEST_OVERRIDE) {
    ...
    m.OVATIONINCENTIVES_TEST_EXPLAIN = process.env.OVATIONINCENTIVES_TEST_EXPLAIN || m.OVATIONINCENTIVES_TEST_EXPLAIN;
    return m;
}
