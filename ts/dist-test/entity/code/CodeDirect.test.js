...
(0, node_test_1.describe)('CodeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.OvationincentivesSDK({
    ...
    (0, node_test_1.test)('direct-load-code', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-code', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.OVATIONINCENTIVES_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.OvationincentivesSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.OVATIONINCENTIVES_APIKEY,
        }));
        let idmap = env['OVATIONINCENTIVES_TEST_CODE_ENTID'];
    ...
    const client = new __1.OvationincentivesSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=CodeDirect.test.js.map