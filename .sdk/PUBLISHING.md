...
|---|---|---|
| `js/` | @voxgig-sdk/ovationincentives-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/ovationincentives | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/ovationincentives-js \
      --repository voxgig-sdk/ovationincentives-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/ovationincentives-js` shows it, and
`npm trust revoke @voxgig-sdk/ovationincentives-js --id=<id>` removes it.
