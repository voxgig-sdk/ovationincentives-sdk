...
// Ovationincentives SDK utility type

class OvationincentivesUtility
{
    ...
    public static function copy(OvationincentivesUtility $src): OvationincentivesUtility
    {
        $u = new OvationincentivesUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
