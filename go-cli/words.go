...
func registerSDKWords(r *eng.Registry, client *sdk.OvationincentivesSDK) {
...
func runOp(client *sdk.OvationincentivesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
