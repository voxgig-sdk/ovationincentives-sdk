# Ovationincentives SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions OvationincentivesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both OvationincentivesSDK(...) and OvationincentivesSDK.test(...) become
#      OvationincentivesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "ovationincentives_sdk"
_SDK_CLASS = "OvationincentivesSDK"
