...
from ovationincentives_sdk.utility import register

# Load features
from ovationincentives_sdk.feature.base_feature import OvationincentivesBaseFeature
from ovationincentives_sdk.features import _has_feature, _make_feature
...
class OvationincentivesSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = OvationincentivesUtility()
        self._utility = utility

        from ovationincentives_sdk.config import shared_config
    ...
    def get_utility(self):
        return OvationincentivesUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("OvationincentivesSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Code(self, data=None) -> "CodeEntity":
        ...
        from ovationincentives_sdk.entity.code_entity import CodeEntity
        return CodeEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "OvationincentivesSDK":
        if sdkopts is None:
            sdkopts = {}
