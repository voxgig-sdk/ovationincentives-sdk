...
from ovationincentives_sdk.core.control import OvationincentivesControl
...
from ovationincentives_sdk.core.helpers import get_ctx_prop, to_map
...
class OvationincentivesContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = OvationincentivesControl()
        ...
        if isinstance(sp, OvationincentivesSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, OvationincentivesResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, OvationincentivesResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return OvationincentivesOperation({})
    ...
    def make_error(self, code, msg):
        return OvationincentivesError(code, msg, self)
