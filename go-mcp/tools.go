...
type Args struct {
	Entity string         `json:"entity" jsonschema:"code"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.OvationincentivesSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "ovationincentives_list",
		Description: "List records from Ovationincentives. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "ovationincentives_load",
		Description: "Load a single record from Ovationincentives. " +
...
func runOp(client *sdk.OvationincentivesSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.OvationincentivesSDK, name string) (sdk.OvationincentivesEntity, error) {
