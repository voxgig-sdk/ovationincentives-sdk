// Command Ovationincentives-mcp is an MCP server exposing the Ovationincentives
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Ovationincentives_list  — list records of an entity
//	Ovationincentives_load  — load a single record of an entity
//
