...
describe("CodeDirect", function()
  it("should direct-load-code", function()
    local setup = code_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-code", setup.live and "live" or "unit")
...
function code_direct_setup(mockres)
