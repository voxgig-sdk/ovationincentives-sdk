...
local function make_error_util(ctx, err)
  ...
  local msg = "OvationincentivesSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = OvationincentivesError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == OvationincentivesError then
