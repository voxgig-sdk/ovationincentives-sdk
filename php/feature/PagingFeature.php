...
// Ovationincentives SDK paging feature
...
class OvationincentivesPagingFeature extends OvationincentivesBaseFeature
{
    ...
    private function _graphql_pre_request(OvationincentivesContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(OvationincentivesContext $ctx): bool
    {
