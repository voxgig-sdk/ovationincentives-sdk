...
// Ovationincentives SDK ratelimit feature
...
class OvationincentivesRatelimitFeature extends OvationincentivesBaseFeature
{
    ...
    private function _acquire(OvationincentivesContext $ctx): void
    {
    ...
    private function _track(OvationincentivesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
