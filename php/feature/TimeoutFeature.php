...
// Ovationincentives SDK timeout feature
...
class OvationincentivesTimeoutFeature extends OvationincentivesBaseFeature
{
    ...
    private function _with_timeout(OvationincentivesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(OvationincentivesContext $_ctx, float $ms): void
    {
        $client = $this->client;
