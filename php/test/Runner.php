...
class OvationincentivesTestRunner
{
    ...
    {
        $live = self::getenv('OVATIONINCENTIVES_TEST_LIVE');
        $override = self::getenv('OVATIONINCENTIVES_TEST_OVERRIDE');
        ...
        $explain = self::getenv('OVATIONINCENTIVES_TEST_EXPLAIN');
...
class_alias('OvationincentivesTestRunner', 'Runner');
class_alias('OvationincentivesHelpers', 'Helpers');
