...
// Ovationincentives SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (OvationincentivesSDK::test)
...
{
    private const SDK_CLASS = 'OvationincentivesSDK';
    ...
    private const SDK_BASE = 'ovationincentives_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../ovationincentives_sdk.php';
