...
// Ovationincentives SDK utility: graphql
//
...
class OvationincentivesGraphql
{
    ...
    // equivalent.
    public static function body(OvationincentivesContext $ctx): mixed
    {
    ...
    public static function errors(OvationincentivesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
