...
// Ovationincentives SDK utility: result_basic

class OvationincentivesResultBasic
{
    public static function call(OvationincentivesContext $ctx): ?OvationincentivesResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof OvationincentivesError) ? $result->err->msg : (string)$result->err;
