...
// Ovationincentives SDK utility: fetcher

class OvationincentivesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; OvationincentivesSDK/1.0)';
    ...
    public static function call(OvationincentivesContext $ctx, string $fullurl, array $fetchdef): array
    {
